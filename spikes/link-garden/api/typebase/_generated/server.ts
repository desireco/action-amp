...
import * as ActionModule1 from "../actions/links.ts";
import * as ActionModule2 from "../actions/stats.ts";

export const router = {
  links: filterActions(ActionModule1),
  stats: filterActions(ActionModule2),
};
...
export declare const action: ActionBuilder<typeof relations, typeof authConfig, typeof envSchema, never>;
