// Better Stack's public frontend tag (application `actionamp`). Keep local
// work out of production telemetry; collection details remain remotely
// configurable in Better Stack.
