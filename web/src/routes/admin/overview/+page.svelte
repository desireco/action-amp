...
<script lang="ts">
  ...
  function setRange(value: FunnelRange) {
    void goto(`/admin/overview?range=${value}`, {
      keepFocus: true,
      noScroll: true,
    });
  }
...
{#if stats}
  ...
  <div class="aa-admin-group">
    <div class="aa-admin-section-head">
      ...
      <a href="/admin/activity">Weekly signups → Activity</a>
    </div>
    <div class="aa-admin-tiles">
      <div class="aa-admin-tile">
        ...
        <a class="aa-admin-tile__label" href="/admin/users?sort=signup_desc">Total signups</a>
      </div>
      <div class="aa-admin-tile">
        ...
        <a class="aa-admin-tile__label" href={`/admin/users${range === "all" ? "?sort=signup_desc" : `?joined=${range}&sort=signup_desc`}`}>New signups · {range}</a>
      </div>
      <div class="aa-admin-tile">
        ...
        <a class="aa-admin-tile__label" href={`/admin/users${range === "all" ? "?sort=last_active_desc" : `?active=${range}&sort=last_active_desc`}`}>Active users · {range}</a>
      </div>
    </div>
  </div>
  ...
  <div class="aa-admin-group">
    <div class="aa-admin-section-head">
      ...
      <a href={`/admin/funnel?range=${range}`}>View funnel →</a>
    </div>
    <div class="aa-admin-tiles">
      <div class="aa-admin-tile">
