<script lang="ts">
  // Task detail (`/tasks/:permalink`) — prose edit only: title + Context
  ...
  // returnTo is guarded to same-origin paths (history state would need
  // navigation state; the webapp parity default is "/").
  const returnTo = "/";
