<script lang="ts">
  ...
  // webapp/src/app/SettingsLayout.tsx: back link "Next" → "/", h1, and the
  ...
  const TABS = [
    { label: "Account", to: "/settings", exact: true },
    { label: "Billing", to: "/settings/billing", exact: false },
    { label: "Preferences", to: "/settings/preferences", exact: false },
    { label: "Lenses", to: "/settings/lenses", exact: false },
    { label: "Access tokens", to: "/settings/pat", exact: false },
  ];
</script>
