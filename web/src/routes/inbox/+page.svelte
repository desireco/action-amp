<script lang="ts">
  ...
  // One-shot URL open (`/?capture=1` and the empty-state CTA): opens
  ...
  <section class="aa-inbox__surface" aria-label="Captured thoughts">
    ...
    {:else if list.length === 0}
      <div class="aa-inbox__empty">
        ...
        <a href="/inbox?capture=1" class="aa-inbox__cta aa-inbox__empty-cta">
    ...
    {:else}
      <div class="aa-inbox__queue-header">
        ...
        <a href="/inbox/review" class="aa-inbox__cta">
