 ...
 *
 * Data: seeded by `apps/api/src/seed-billing.ts` (run it before the suite —
 * the lenses-spec convention; the shared global-setup doesn't know this seed):
 *   cd apps/api && DATABASE_URL=postgresql://jake@localhost:5432/actionamp_dev bun src/seed-billing.ts
 *
 ...
 *   apps/api/src/webhooks-stripe.test.ts (24 webapp cases ported).
 */
