...
If there's a single thing to lock in, it's the weekly triage. Not doing the work. Just looking at the inbox and deciding, item by item, what each thing is and where it goes. Twenty minutes. It is, by a wide margin, the highest-leverage twenty minutes in any system, because it's the step that keeps the inbox from becoming a swamp and the task list from becoming a wishlist.

Most people never establish it. They capture, they act, they wonder why the list is a mess. The triage is the missing step, and it is also the only step that feels like overhead, which is why it gets skipped. Do it anyway. For a month. After that the relief is its own argument.

## What this becomes

From these five things, the full methodology opens up if you need it. Someday lists for the maybes. Multiple goals once one is rolling. Projects broken into sub-projects when they get complex. A lens or context system for separating work from life.
