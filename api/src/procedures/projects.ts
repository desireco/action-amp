 ...
 * api/src/router.ts lives in docs/plans/slices/s5-s6-wiring.md.
 */
 ...
 * more, so the data is covered. The path stays because web's typed
 * client (built from this contract) still calls `projects.moveTargets`, and
 * both the contract fragment and web are outside this layer's scope;
 ...
 * web's typed client still calls `projects.setTaskStatus`; retiring it
