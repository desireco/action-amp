...
| The platform switch off Wasp (Svelte/Bun — single switch, no migration period) | `docs/plans/2026-08-31-platform-switch-v3.md` (supersedes v1/v2 in the same folder) |
