...
| The platform transition off Wasp (Svelte/Bun, phases, auth bridge) | `docs/plans/2026-08-31-platform-transition-v2.md` (supersedes the v1 plan + review in the same folder) |
