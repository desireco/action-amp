...
| **NEXT SESSION: fix the P1 punch list** | ☐ | visual-drift.md P1s: shrink-wrapped columns (one flex fix, 3 surfaces), week hero card, admin double-sidebar, sidebar counts/badges (needs contract counts + review routes) |
