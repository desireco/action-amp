...
- [error-tracking](./error-tracking.md) (`shipped`, spec `done`) — sanitized server stacks in Railway, Better Stack frontend tracking, request IDs, and a root render-failure recovery screen.
