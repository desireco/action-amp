...
export default app({
  ...
  spec: [
    ...
    action(toggleTaskDone, {
      entities: ["Task", "User", "AnalyticsSession", "AnalyticsEvent"],
    }),
    ...
    action(completeFocusSession, {
      entities: ["Task", "TaskSession", "AnalyticsSession", "AnalyticsEvent"],
      auth: true,
    }),
    action(addTaskUpdate, { entities: ["Task", "TaskUpdate"], auth: true }),
    action(updateTaskContent, { entities: ["Task"], auth: true }),
    action(setTaskOutcome, {
      entities: ["Task", "AnalyticsSession", "AnalyticsEvent"],
    }),
    ...
    action(grantAdminUserAccess, {
      entities: ["User", "AdminUserAction"],
      auth: true,
    }),
    action(removeAdminUserAccess, {
      entities: ["User", "AdminUserAction"],
      auth: true,
    }),
    action(deleteAdminUser, {
      entities: ["User", "AdminUserAction", "MagicLoginChallenge"],
      auth: true,
    }),
    action(deleteAdminUsers, {
      entities: ["User", "AdminUserAction", "MagicLoginChallenge"],
      auth: true,
    }),
