 ...
 *
 * `plan` + `planRenewsAt` live on the auth user (the User entity spreads into
 * AuthUserData), so no extra query is needed. Returns true while the user is
 * entitled to paid features (active PRO, or FOUNDER). Use this to decide
 * whether to show cap UI, the Work-lens gate, etc.
 *
