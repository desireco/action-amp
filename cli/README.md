...
| `ritual create <name> [--interval morning\|midday\|evening] [--cadence daily\|weekdays\|weekly\|interval] [--weekday mon..sun] [--every <days>] [--guidance <text>] [--benefit <text>]` | Create a ritual (defaults: morning, every day, Me lens)                                                                      |
| `ritual update <id> [--name] [--interval] [--cadence] [--weekday] [--every] [--guidance] [--benefit]` | Edit; `--guidance ""` clears (`--benefit` too)                                                                               |
